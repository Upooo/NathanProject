...
from NP import YouTube, app
from NP.core.call import Anony
from NP.misc import SUDOERS, db
from NP.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from NP.utils.formatters import seconds_to_min
from NP.utils.inline import close_markup, stream_markup, stream_markup_timer
from NP.utils.stream.autoclear import auto_clean
